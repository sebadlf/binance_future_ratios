...
def main():
    ...
    # twm.start_multiplex_socket(['bnbbtc@aggTrade', 'neobtc@ticker'])

    twm.start_multiplex_socket(callback=handle_socket_message, streams=['bnbbtc@aggTrade', 'neobtc@ticker'])
